...
class ProjectTaskMassUpdate(models.TransientModel):
    """
    Wizard for mass updating selected task attributes such as assignees,
    deadlines, projects, stages, and tags.
    """
    ...
    def update_task_details(self):
        """
        Executes the mass update on all selected tasks based on the values
        provided in the wizard fields.
        """
        if self.user_ids:
