...
class IrAttachment(models.Model):
    """
    Inherits from 'ir.attachment' to manage document expiry dates
    and handle automated expiry notifications for owners and customers.
    """
    ...
    def _onchange_res_id(self):
        """
        Automatically links the related project's customer to the attachment
        when the resource ID is updated.
        """
    ...
    def document_expire_notification(self):
        """
        Scans attachments for upcoming or past expiry dates and sends
        email notifications to customers and internal owners accordingly.
        """
